...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    total_waste = str(total_material - material_consumed)
    return total_waste + material_units
...
def interest(principal, rate, periods):
    ...
    interest_amt = float(1 + (rate * periods))
    total = int(principal * interest_amt)
    return total
...
def body_mass_index(weight, height):
    ...
    height_inches = int(foot * 12 + inch) 
...
foot = int(input("Enter your height (feet): "))
